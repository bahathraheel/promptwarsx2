...
router.get("/text-mode", (req, res) => {
  try {
    ...
    const textContent = {
      ...
      accessibilityNote:
        "This page is designed for screen readers and low-bandwidth connections. All interactive 3D features are available on the main page. For assistance, call 1-866-OUR-VOTE.",
    };
    ...
    res
      .status(500)
      .json({ success: false, error: { message: "Failed to load content" } });
  }
});
