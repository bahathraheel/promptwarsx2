...
class AssistantUI {
  ...
  async sendMessage() {
    ...
    try {
      ...
      if (data.success) {
        ...
        const confidenceTag = data.data.confidence === 'low' ? ' • General info' : '';
        this.addBotMessage(data.data.answer, modelTag ? modelTag + confidenceTag : null);
        ...
        this.addBotMessage("I'm sorry, I couldn't process that. Please try rephrasing your question or call 1-866-OUR-VOTE for live assistance.");
      }
    } catch (error) {
      this.removeTypingIndicator(typingId);
      this.addBotMessage("I'm currently offline. Here's a tip: visit **vote.gov** for official election information, or call **1-866-OUR-VOTE** for immediate help.");
    }
  ...
  clearHistory() {
    ...
    this.addBotMessage("🔄 Conversation cleared! Ask me anything about elections.");
    this._showDefaultFollowUps();
  }
